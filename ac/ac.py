...
def main():
    ...
    parser_init.add_argument('-d', '--download', action='store_false',
                             help='download testcases when the contest starts')
    parser_init.add_argument('-a', '--show-a', action='store_true',
    ...
    parser_submit.add_argument(
        '-p', '--compile', default='', help='compile command')
    parser_submit.add_argument(
        '-s', '--source_path', default='', help='source path')
    parser_submit.add_argument(
    ...
    parser_copy.add_argument('-s', '--source_path',
