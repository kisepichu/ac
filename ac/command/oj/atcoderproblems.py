...
class AtCoderProblems:
	...
	def get_start_time(self, contest_id):
		...
		elem = self.session.find_element_by_xpath("/html[@class='theme-dark']/body/div[@id='root']/div/div[@class='my-5 container']/div[@class='my-2 row'][1]/div[@class='col-md-12 col-lg-6'][1]/table[@class='mb-0 table']/tbody/tr[1]/td")
		start_str = elem.text
		print(start_str)
